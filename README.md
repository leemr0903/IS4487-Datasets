...
|------|-------------------------------|--------------------------------------------------|----------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------|
| 1    | Overview of Business Analytics | —                                                | Intro week, foundational tools                          | Case Studies                                                 | Applied case study analysis to introduce business context      |
| 2    | Intro to Analytical Models     | [mtcars](#mtcars)                                 | Basic syntax and data operations                         | [Hotels](#hotels)                                            | Large, structured, clean for first modeling                    |
| 3    | Business Understanding         | [AdviseInvest](#adviseinvest)                     | Use Megatelco survey for relatable business case         | [Student Loan Payments](#student-loan-payments)              | Socioeconomic context, repayment target                        |
| 4    | Data Understanding             | [AdviseInvest](#adviseinvest)                     | Familiar categories, customer segments, dates            | [School Diversity](#school-diversity)                        | % diversity measures, clustering ready                         |
| 5    | EDA – Summary Measures         | [Wealth and Income Over Time](#wealth-and-income-over-time) | Clear churn outcome, mixed data types               | [Superstore Retail Orders](#superstore-retail-orders)        | Cluster based on sales/discount/profit                         |
| 6    | Data Preparation               | [SF Rents](#sf-rents)                             | NAs, duplicates, categories to bin or encode             | [Economic Diversity & Student Outcomes](#economic-diversity-and-student-outcomes) | Multi-source merge, regression prep |
| 7    | Data Transformation            | [SF Rents](#sf-rents)                             | Good example for label encoding and scaling              | [Global Holidays & Travel](#global-holidays-and-travel)      | Time/geospatial flags, holiday creation                        |
| 8    | Exam Week                      | —                                                | —                                                        | —                                                            | —                                                              |
| 9    | Modeling & Evaluation I        | [Megatelco](#megatelco)                           | Cluster churners by behavior                             | [School Diversity](#school-diversity)                        | Segment districts by diversity                                 |
| 10   | Modeling & Evaluation II       | [Megatelco](#megatelco)                           | Predict churn using telcom survey                        | [Hotels](#hotels)                                            | Build decision tree or KNN on cancellation flag                |
| 11   | Modeling & Evaluation III      | [Big Tech Stock Prices](#big-tech-stock-prices)   | Environmental data with clear trends                     | [Monthly State Retail Sales](#monthly-state-retail-sales)    | Predict retail sales using economic indicators                 |
...
| 13   | Modeling & Evaluation V        | [Amazon Reviews](#amazon-reviews)                 | Practice tokenization and vectorization                  | [GPT Detectors](#gpt-detectors)                              | Evaluate model flags or derived notes                          |
