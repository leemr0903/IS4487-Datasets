...
|------|----------------------------------|-------------------------------------------|------------------------------------------------------------|----------------------------------------------|----------------------------------------------------------------|
| 1    | Overview of Analytics            | —                                         | Intro week, no lab dataset                                 | [Hotels](#hotels)                            | Simple structure, 32 vars, binary target for later reuse       |
| 2    | Analytical Model Types           | [Super Bowl Commercials](#super-bowl-commercials) | Text flags + category features for comparison modeling     | [SF Rents](#sf-rents)                        | Regression-friendly target (`rent`), large volume for EDA      |
| 3    | Business Understanding           | [Big Tech Stock Prices](#big-tech-stock-prices) | Easy to explain KPIs, public company context              | [Student Loan Payments](#student-loan-payments) | Outcome/repayment rate context, useful demographics            |
| 4    | Data Exploration & Visualization | [Wealth & Income Over Time](#wealth-and-income-over-time) | Trend analysis, demographic comparisons                    | [School Diversity](#school-diversity)        | Clean % fields, clustering by diversity                         |
| 5    | Data Preparation                 | [Monthly State Retail Sales](#monthly-state-retail-sales) | Seasonal prep, handling NAs and normalization              | [Economic Diversity & Outcomes](#economic-diversity-and-student-outcomes) | Merge needed, good for prep before modeling                    |
| 6    | Encoding & Feature Engineering   | [Global Holidays & Travel](#global-holidays-and-travel) | Geographic + temporal variables and flag creation          | [Student Loan Payments](#student-loan-payments) (reused) | Binning, dummy variables, standardization practice             |
| 7    | Data Transformation & Scaling    | [Pixar Films](#pixar-films)               | Budget and revenue scaling, time-based transformation      | [Hotels](#hotels) (reused)                   | Apply transformations and encoding; used only in assignments   |
| 8    | Exam Week                        | —                                         | —                                                          | —                                            | —                                                              |
| 9    | Clustering & Segmentation        | [School Diversity](#school-diversity) (reused in labs) | Cluster by diversity or grade span                         | [Superstore Retail Orders](#superstore-retail-orders) | Cluster customers on spend/discount/profit                     |
| 10   | Classification Modeling          | [Megatelco Leave Survey](#megatelco-leave-survey) | Binary target, mix of categorical/numeric vars             | [Hotels](#hotels) (reused again)             | Classification using decision trees or SVM                     |
| 11   | Regression Modeling              | [Big Tech Stock Prices](#big-tech-stock-prices) (reused in labs) | Time-series regression problem                            | [Student Loan Payments](#student-loan-payments) (reused again) | Continuous target, institutional comparisons                   |
| 12   | Model Tuning (Advanced Models)   | [Amazon Reviews](#amazon-reviews)         | Free text, labeled sentiment — tune classifiers            | [Economic Diversity & Outcomes](#economic-diversity-and-student-outcomes) (reused) | Model tuning on structured vars                                |
| 13   | Text Analytics & Evaluation      | [GPT Detectors](#gpt-detectors)           | Text classification with probability predictions           | [Student Loan Payments](#student-loan-payments) (reused again) | Evaluate models with flags or user notes                       |
| 14   | Deployment & MLOps Concepts      | [Global Holidays & Travel](#global-holidays-and-travel) (reused in labs) | Forecast holidays, build simulated deployment logic        | [SF Rents](#sf-rents) (reused)               | Deploy rent model via API or interface                         |
| 15   | Final Project & Wrap-Up          | Student Choice                            | Integrate all concepts                                     | —                                            | Final project only                                             |
