...
| 6      | Data Preparation               | [Megatelco_Duplicates](#megatelco_duplicates) | NAs, duplicates, categories to bin or encode                    | [Inside Airbnb – City Dataset](https://insideairbnb.com/get-the-data/) | Prepare categorical and text-heavy listings for modeling       |
| 7      | Data Transformation            | [Megatelco_Duplicates](#megatelco_duplicates) | Label encoding, scaling, feature engineering                   | [Inside Airbnb – City Dataset](https://insideairbnb.com/get-the-data/) | Transform pricing, availability, and feature columns           |
| 8      | Exam Week                      | —                                            | —                                                              | —                                                                 | —                                                              |
| 9      | Modeling & Evaluation I        | [SF Rents](#sf-rents)                        | Segment listings using KMeans                                   | [Hotels](#hotels)                                                 | Cluster hotels based on location, price, and features          |
...
| 11     | Modeling & Evaluation III      | [Employee Attrition](#employee-attrition)    | Real-world HR classification problem                            | [Global Holidays & Travel](#global-holidays-and-travel)          | Forecast travel needs from holiday timing and type             |
| 12     | Modeling & Evaluation IV       | [Super Bowl Commercials](#super-bowl-commercials) | Many binary flags + label for NLP                     | [GPT Detectors](#gpt-detectors) or Super Bowl dataset             | Text classification, model tuning                              |
| 13     | Modeling & Evaluation V        | [Online Food Orders & Restaurant Reviews](#online-food-orders) | Practice tokenization, vectorization, and feedback analysis | [Amazon Sales Dataset](https://www.kaggle.com/datasets/karkavelrajaj/amazon-sales-dataset) | Analyze product reviews or sales performance                   |
| 14     | Model Deployment               | [Reddit Post Titles](#reddit-post-titles)    | Topic modeling or classification from online text              | [YFinance – Stock Prices](https://finance.yahoo.com/)             | Deploy price alert or trend detector model                     |
