...
| Week | Topic                        | Lab Dataset                                                                                         | Reason (Lab)                                                  | Assignment Dataset                                                                                 | Reason (Assignment)                                              |
|------|------------------------------|------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------|
| 1    | Overview of Analytics        | —                                                                                                    | No lab (intro week)                                            | [Hotels](#hotels)                                                                                   | Clean business data with rich metadata and straightforward vars |
| 2    | Analytical Models            | —                                                                                                    | Intro to types, no dataset needed                              | [Amazon Reviews](#amazon-reviews)                                                                   | Easy to classify analytics types; short texts + label           |
| 3    | Business Understanding       | [Megatelco New Customer Data](#megatelco-new-customer-data)                                         | Customer metrics with clear business framing                  | [Superstore Retail Orders](#superstore-retail-orders)                                             | Familiar business context, segmentable categories                |
| 4    | Data Understanding           | [Global Holidays and Travel](#global-holidays-and-travel)                                           | Clean, geo/time data—good for profiling and parsing           | [Student Loan Payments](#student-loan-payments)                                                   | Basic structure, continuous fields for summary stats            |
| 5    | EDA                          | [Megatelco Leave Survey](#megatelco-leave-survey)                                                   | Mix of numeric + categorical with churn target                | [AdviseInvest New Customer Data](#adviseinvest-new-customer-data)                                | Unlabeled; explore distributions and pattern detection          |
| 6    | Data Preparation             | [SF Rents](#sf-rents)                                                                               | Needs NA handling, scaling, encoding                          | [Super Bowl Commercials](#super-bowl-commercials)                                                 | Categorical variables for practice encoding and flag creation   |
| 7    | Data Transformation          | [Monthly State Retail Sales](#monthly-state-retail-sales)                                           | Includes time, state, and retail variables; ready for scaling | [GPT Detectors](#gpt-detectors)                                                                    | Simple binary target, good for label encoding                   |
| 8    | **Exam Week**                | —                                                                                                    | —                                                              | —                                                                                                    | —                                                                |
| 9    | Modeling & Eval I (Cluster)  | [Megatelco New Customer Data](#megatelco-new-customer-data)                                         | Segment usage/satisfaction or price sensitivity               | [Superstore Retail Orders](#superstore-retail-orders)                                             | Cluster on sales/profit/discount                                |
| 10   | Modeling & Eval II (Class.)  | [Megatelco Leave Survey](#megatelco-leave-survey)                                                   | Binary churn; great class/feature balance                     | [AdviseInvest Historical](#adviseinvest-historical-customer-data)                                 | Simple binary classification on customer history                |
| 11   | Modeling & Eval III (Reg.)   | [Big Tech Stock Prices](#big-tech-stock-prices)                                                     | Predict price change or close; ideal time series setup        | [Student Loan Payments](#student-loan-payments)                                                   | Predict repayment rate or amount                                |
| 12   | Modeling & Eval IV (Adv.)    | [Amazon Reviews](#amazon-reviews)                                                                   | Free text; feature engineering and sentiment regression       | [Hotels](#hotels)                                                                                   | Fit multiple models (regression/classification) with ease       |
