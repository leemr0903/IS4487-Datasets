...
|--------|-------------------------------|--------------------------------------------------|----------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------|
| 1      | Overview of Business Analytics | —                                                | Intro week, foundational tools                          | —                                                            | —                                                              |
| 2      | Intro to Analytical Models     | [mtcars](#mtcars)                                 | Basic syntax and data operations                         | —                                                            | —                                                              |
| 3      | Business Understanding         | [AdviseInvest](#adviseinvest)                     | Business case                                            | —                                                            | —                                                              |
...
| 5      | EDA – Summary Measures         | [Superstore Retail Orders](#superstore-retail-orders) | Cluster-ready data, mixed types                     | [Hotels](#hotels)                                            | Structured records to explore summaries & distributions        |
| 6      | Data Preparation               | [SF Rents](#sf-rents)                             | NAs, duplicates, categories to bin or encode             | —                                                            | —                                                              |
